...
def start(message):
    ...
    hello_message = hello_message + "\n\n" + "Я работаю со всеми кодексами, принятыми в РБ: УК, УПК, ГК, ГПК, КоАП, ПИКоАП, ХПК, ТК, КоБС, НК, Таможенный кожекс, БК (Банковский кодекс), Бюджетный кодекс, Кодекс о земле, ЖК, УИК, Кодекс об образовании, ЛК, Кодекс о недрах, Воздушный кодекс, Водный кодекс, Кодекс о судоустройстве и статусе судей, ИК, Кодекс внутренного водного транспорта, Кодекс торгового мореплавания"
