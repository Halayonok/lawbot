...
codes = {
    ...
    "tam_k" : ['ткс', 'Ткс', 'ТКС', 'тамк', 'Тамк', 'ТАМК', 'таможенный', 'Таможенный', 'таможенный кодекс', 'Таможенный кодекс', 'Таможенный Кодекс', 'таможенный кодекс еаэс', 'ЕЭАС кодекс'],
    ...
    "k_o_nedrah" : ['кон', 'Кон', 'КОН', 'о недрах', 'О недрах', 'Кодекс о недрах', 'кодекс о недрах', 'Кодекс о Недрах', 'Кодекс О Недрах', 'кодекс о Недрах'],
    "k_o_sud" : ['кос', 'Кос', 'КОС', 'косис', 'Косис', 'КОСИС', 'о судоустройстве', 'О судоустройстве', 'о статусе судей', 'О статусе судей', 'кодекс о судоустройстве', 'Кодекс о судоустройстве', 'Кодекс о статусе судей', 'кодекс о судоустройстве и статусе судей', 'кодекс о статусе судей'],
    "k_torg_more" : ['ктм', 'Ктм', 'КТМ', 'кодекс мореплавания', 'Кодекс мореплавания', 'о мореплавании', 'О мореплавании', 'Кодекс торгового мореплавания', 'кодекс торгового мореплавания'],
    "vod_k" : ['водный кодекс', 'Водный кодекс', 'водный', 'Водный', 'Водный Кодекс', 'вк', 'Вк', 'ВК', 'водк', 'Водк', 'ВОДК'],
    "voz_k" : ['Воздушный', 'воздушный', 'воздушный кодекс', 'Воздушный кодекс', 'Воздушный Кодекс', 'возк', 'Возк', 'ВОЗК'],
    "k_vnut_vod_tran" : ['кввт', 'Кввт', 'КВВТ', 'Кодекс внутренного водного', 'Кодекс внутренного водного транспорта', 'кодекс внутренного водного', 'кодекс внутренного водного транспорта', 'внутренного водного транспорта', 'Внутренного водного транспорта']
}
